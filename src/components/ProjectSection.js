...
import rotary from './rotary.svg'
import bean from './88beans.png'
import qvinyl from './qvinyl.png'
                    ...
                    <div className="section">
                        ...
                        <div className="section-content" id={id}>
                            <Card
                                title="Qvinyl"
                                image={qvinyl}
                                subtitle="Firebase, React, JavaScript, HTML, CSS"
                                ...
                                link="https://qvinyl.github.io/Qvinyl/"
                            />
                            <Card
                                title="88 Beans"
                                image={bean}
                            ...
                            <Card
                                title="BudgetTracker"
                                image={budget}
                                subtitle="Web2py, JavaScript, Chart.js, HTML, CSS"
