...
const Projects = () => {
    const projects = [
        {
            title: 'Qvinyl2.0',
            stack: '(Full-stack) Docker, Cloud Plat.(GCP), RestAPI, MySQL, React, Tomcat, Youtube API, Socket.io, Firestore, Material-UI, Reactstrap',
        ...
        {
            title: 'Qvinyl',
            stack: '(Full-stack) Firebase, React, JavaScript, HTML, CSS',
            description: 'Qvinyl is a web application that allows users to queue up Youtube videos / playlists to be played synchronously across mutiple devices. I played the role of scrum master, organizing code sessions and meetings to ensure project goals were met. In addition, I designed a robust backend infrastructure on Firebase to effienctly store user information, text messages, room data, and YouTube links in the queue.',
            link: '',
            image: qvinyl
        },
        {
            title: 'BudgetTracker',
            stack: '(Front-end) Web2py, JavaScript, Chart.js, HTML, CSS',
        ...
        },
        {
            ...
            stack: '(Front-end) JavaScript, HTML, CSS',
