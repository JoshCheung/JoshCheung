    ...
    return (
        <div>
            <div className="profile">
                <h4>Hi! I'm Josh!</h4>
                <p>
                I'm a Software Engineer based in Alameda, California. I am a recent grad from UC Santa Cruz.
                </p>

                <p>
                I am passionate about software engineering and always find it interesting how simple 0’s and 1’s can turn into massive applications that can connect people all around the world.
